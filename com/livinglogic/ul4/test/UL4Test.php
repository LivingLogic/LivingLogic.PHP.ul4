...
// 		$c = new EvaluationContext(array('x' => "й"));  // TODO  1081
      ...
      var_dump($c->getOutput());
		...
		var_dump($c->get("c"));
		// LoadFloat
		$s1 = "OS27|de.livinglogic.ul4.storevarOS27|de.livinglogic.ul4.locationS15|<?code c=2.71?>S4|codei0|i15|i7|i13|S1|cOS24|de.livinglogic.ul4.float^2|f2.71|";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$p->evaluate($c);
		var_dump($c->get("c"));
		// LoadNone
		$s1 = "OS27|de.livinglogic.ul4.storevarOS27|de.livinglogic.ul4.locationS15|<?code c=None?>S4|codei0|i15|i7|i13|S1|cOS23|de.livinglogic.ul4.none^2|";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$p->evaluate($c);
		var_dump($c->get("c"));
		// Var
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS11|<?print x?>S5|printi0|i11|i8|i9|OS22|de.livinglogic.ul4.var^2|S1|x";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array("x" => "42"));
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS17|<?print x and y?>S5|printi0|i17|i8|i15|OS22|de.livinglogic.ul4.and^2|OS22|de.livinglogic.ul4.var^2|S1|xO^9|^2|S1|y";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array("x" => "42", "y" => false));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// Or
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS16|<?print x or y?>S5|printi0|i16|i8|i14|OS21|de.livinglogic.ul4.or^2|OS22|de.livinglogic.ul4.var^2|S1|xO^9|^2|S1|y";
		...
		var_dump($c->get("x"));
		// rsplit()
		$s1 = "OS27|de.livinglogic.ul4.storevarOS27|de.livinglogic.ul4.locationS27|<?code x = 'a b'.rsplit()?>S4|codei0|i27|i7|i25|S1|xOS27|de.livinglogic.ul4.callmeth^2|S6|rsplitOS22|de.livinglogic.ul4.str^2|S3|a bL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$p->evaluate($c);
		var_dump($c->get("x"));
		// rsplit(",")
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS31|<?print ',a,,b,c'.rsplit(',')?>S5|printi0|i31|i8|i29|OS27|de.livinglogic.ul4.callmeth^2|S6|rsplitOS22|de.livinglogic.ul4.str^2|S7|,a,,b,cLO^10|^2|S1|,]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		// strip
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS26|<?print '  a b '.strip()?>S5|printi0|i26|i8|i24|OS27|de.livinglogic.ul4.callmeth^2|S5|stripOS22|de.livinglogic.ul4.str^2|S6|  a b L]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		// lstrip
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS27|<?print '  a b '.lstrip()?>S5|printi0|i27|i8|i25|OS27|de.livinglogic.ul4.callmeth^2|S6|lstripOS22|de.livinglogic.ul4.str^2|S6|  a b L]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		// rstrip
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS27|<?print '  a b '.rstrip()?>S5|printi0|i27|i8|i25|OS27|de.livinglogic.ul4.callmeth^2|S6|rstripOS22|de.livinglogic.ul4.str^2|S6|  a b L]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		// upper
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS23|<?print 'a b'.upper()?>S5|printi0|i23|i8|i21|OS27|de.livinglogic.ul4.callmeth^2|S5|upperOS22|de.livinglogic.ul4.str^2|S3|a bL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		// lower
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS23|<?print 'A B'.lower()?>S5|printi0|i23|i8|i21|OS27|de.livinglogic.ul4.callmeth^2|S5|lowerOS22|de.livinglogic.ul4.str^2|S3|A BL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		var_dump($c->getOutput());
		// items
		$s1 = "OS23|de.livinglogic.ul4.foruOS27|de.livinglogic.ul4.locationS72|<?for (k,v) in {'a':0, 'b':1}.items()?><?print k?><?print v?><?end for?>S3|fori0|i39|i6|i37|O^3|^4|S3|endi61|i72|i67|i70|LOS24|de.livinglogic.ul4.printO^3|^4|S5|printi39|i50|i47|i48|OS22|de.livinglogic.ul4.var^11|S1|kO^10|O^3|^4|^12|i50|i61|i58|i59|O^14|^17|S1|v]OS27|de.livinglogic.ul4.callmeth^2|S5|itemsOS23|de.livinglogic.ul4.dict^2|LLOS22|de.livinglogic.ul4.str^2|S1|aOS22|de.livinglogic.ul4.int^2|i0|]LO^28|^2|S1|bO^31|^2|i1|]]L]L^15|^19|]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array());
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		var_dump($c->getOutput());
		// MIMEFormat
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS24|<?print x.mimeformat()?>S5|printi0|i24|i8|i22|OS27|de.livinglogic.ul4.callmeth^2|S10|mimeformatOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new \DateTime()));
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		var_dump($c->getOutput());
		// hls
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS17|<?print x.hls()?>S5|printi0|i17|i8|i15|OS27|de.livinglogic.ul4.callmeth^2|S3|hlsOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(2, 4, 6, 8)));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// hlsa
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS18|<?print x.hlsa()?>S5|printi0|i18|i8|i16|OS27|de.livinglogic.ul4.callmeth^2|S4|hlsaOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(2, 4, 6, 8)));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// hsv
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS17|<?print x.hsv()?>S5|printi0|i17|i8|i15|OS27|de.livinglogic.ul4.callmeth^2|S3|hsvOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(2, 4, 6, 8)));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// hsva
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS18|<?print x.hsva()?>S5|printi0|i18|i8|i16|OS27|de.livinglogic.ul4.callmeth^2|S4|hsvaOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(2, 4, 6, 8)));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// lum
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS17|<?print x.lum()?>S5|printi0|i17|i8|i15|OS27|de.livinglogic.ul4.callmeth^2|S3|lumOS22|de.livinglogic.ul4.var^2|S1|xL]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(2, 4, 6, 8)));
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		var_dump($c->getOutput());
		// startsWith
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS25|<?print x.startswith(y)?>S5|printi0|i25|i8|i23|OS27|de.livinglogic.ul4.callmeth^2|S10|startswithOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => "abcd", 'y' => 'abx'));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// endsWith
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS23|<?print x.endswith(y)?>S5|printi0|i23|i8|i21|OS27|de.livinglogic.ul4.callmeth^2|S8|endswithOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => "abcd", 'y' => 'bd'));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// find with string
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS19|<?print x.find(y)?>S5|printi0|i19|i8|i17|OS27|de.livinglogic.ul4.callmeth^2|S4|findOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => "abcd", 'y' => 'c'));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// find with array
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS19|<?print x.find(y)?>S5|printi0|i19|i8|i17|OS27|de.livinglogic.ul4.callmeth^2|S4|findOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => array(0, 1, 2, 3), 'y' => 3));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// rfind with array
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS20|<?print x.rfind(y)?>S5|printi0|i20|i8|i18|OS27|de.livinglogic.ul4.callmeth^2|S5|rfindOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => array(0, 1, 2, 3), 'y' => 3));
		$p->evaluate($c);
		var_dump($c->getOutput());
		...
		var_dump($c->getOutput());
		// withLum
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS22|<?print x.withlum(y)?>S5|printi0|i22|i8|i20|OS27|de.livinglogic.ul4.callmeth^2|S7|withlumOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(32, 64, 128), 'y' => 0.5));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// witha
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS20|<?print x.witha(y)?>S5|printi0|i20|i8|i18|OS27|de.livinglogic.ul4.callmeth^2|S5|withaOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => new Color(32, 64, 128), 'y' => 55));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// join
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS19|<?print x.join(y)?>S5|printi0|i19|i8|i17|OS27|de.livinglogic.ul4.callmeth^2|S4|joinOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => '0', 'y' => array('a', 'b', 'c')));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// join
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS19|<?print x.join(y)?>S5|printi0|i19|i8|i17|OS27|de.livinglogic.ul4.callmeth^2|S4|joinOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|y]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => '0', 'y' => 'abc'));
		$p->evaluate($c);
		var_dump($c->getOutput());
		// replace
		$s1 = "OS24|de.livinglogic.ul4.printOS27|de.livinglogic.ul4.locationS25|<?print x.replace(y, z)?>S5|printi0|i25|i8|i23|OS27|de.livinglogic.ul4.callmeth^2|S7|replaceOS22|de.livinglogic.ul4.var^2|S1|xLO^10|^2|S1|yO^10|^2|S1|z]";
		$p = \com\livinglogic\ul4on\Utils::loads($s1);
		$c = new EvaluationContext(array('x' => 'abcde', 'y' => 'c', 'z' => 'C'));
		$p->evaluate($c);
		var_dump($c->getOutput());
